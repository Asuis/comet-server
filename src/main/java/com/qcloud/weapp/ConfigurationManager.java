...
public class ConfigurationManager {
	...
	public static void setup(com.qcloud.weapp.Configuration configuration) throws ConfigurationException {
		...
		if (configuration.getServerHost() == null) {
			throw new ConfigurationException("服务器主机配置不能为空");
		}
		if (configuration.getAuthServerUrl() == null) {
			throw new ConfigurationException("鉴权服务器配置不能为空");
		}
		if (configuration.getTunnelServerUrl() == null) {
			throw new ConfigurationException("信道服务器配置不能为空");
		}
		if (configuration.getTunnelSignatureKey() == null) {
			throw new ConfigurationException("SDK 密钥配置不能为空");
		}
